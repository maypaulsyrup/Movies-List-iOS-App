...
- (void)viewDidLoad {
    ...
    self.movies = @[@"fight-club-1999-backdrop.jpg", @"the-dark-knight-2008-backdrop.jpg", @"the-godfather-1972-backdrop.jpg", @"the-godfather-part-ii-1974-backdrop.jpg", @"the-shawshank-redemption-1994-backdrop.jpg"];
}
...
- (UITableViewCell *)tableView:(UITableView *)tableView cellForRowAtIndexPath:(NSIndexPath *)indexPath {
    ...
    // Configure the cell...
    cell.backdropView.image = [UIImage imageNamed:self.movies[indexPath.row]];
